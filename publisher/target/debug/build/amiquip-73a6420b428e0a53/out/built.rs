...
#[allow(dead_code)]
pub const RUSTC: &str = r"C:\\Users\\USER\\.rustup\\toolchains\\stable-x86_64-pc-windows-msvc\\bin\\rustc.exe";
#[doc=r#"The documentation generator that cargo resolved to use."#]
#[allow(dead_code)]
pub const RUSTDOC: &str = r"C:\\Users\\USER\\.rustup\\toolchains\\stable-x86_64-pc-windows-msvc\\bin\\rustdoc.exe";
...
#[doc=r#"The output of `C:\Users\USER\.rustup\toolchains\stable-x86_64-pc-windows-msvc\bin\rustc.exe -V`"#]
#[allow(dead_code)]
pub const RUSTC_VERSION: &str = r"rustc 1.85.0 (4d91de4e4 2025-02-17)";
#[doc=r#"The output of `C:\Users\USER\.rustup\toolchains\stable-x86_64-pc-windows-msvc\bin\rustdoc.exe -V`"#]
#[allow(dead_code)]
pub const RUSTDOC_VERSION: &str = r"rustdoc 1.85.0 (4d91de4e4 2025-02-17)";
